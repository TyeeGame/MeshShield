...
Based on upstream 77aeaf20189d97b7fa2bd0fdc67087d7e636bacb. Migration commit 31e45bd was merged into main through pull request #1 (merge commit 7ea417a). Replaces Xenon/I2C ingress with bounded USB packet ingress; adds laptop traffic generation with fair per-device scheduling and no catch-up bursts; checks firmware handshake; exposes the mode selector in hardware; retains gateway policy and acknowledgment semantics. Removes Xenon projects/configuration and obsolete wiring guide. Includes prior training-restart and dashboard timeout fixes. See README for setup and VALIDATION.md for automated checks and user-reported physical results.
